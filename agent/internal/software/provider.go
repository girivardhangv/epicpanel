	...
	return []Provider{
		{
			...
			Packages: map[string][]string{
				...
				"winget": {"winget", "install", "-e", "--id", "NGINX.NGINX", "--accept-package-agreements", "--accept-source-agreements"},
			},
			Service: "nginx",
		},
		{
		...
		},
		{
			...
			Packages: map[string][]string{
				...
				"winget": {"winget", "install", "-e", "--id", "MariaDB.MariaDB", "--accept-package-agreements", "--accept-source-agreements"},
			},
			Service: "mariadb",
		},
		{
		...
		},
		{
			...
			Packages: map[string][]string{
				...
				"winget": {"winget", "install", "-e", "--id", "OpenJS.NodeJS.LTS", "--accept-package-agreements", "--accept-source-agreements"},
			},
			Service: "",
		},
		{
